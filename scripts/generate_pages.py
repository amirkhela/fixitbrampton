...
SERVICES = {
    ...
    "appliance-installation": {
        ...
        "pa": "ਉਪਕਰਣ ਇੰਸਟਾਲੇਸ਼ਨ",
        "short_verb": "install an appliance",
        "hero_adjective": "hooked up properly, not roughly",
        "price_from": 120, "price_to": 320, "price_hint": "disposal of old unit extra",
        "intro": "The new washer is in the hallway but the dryer plug has only three prongs. The dishwasher needs to mount under the counter. The range hood needs venting through the soffit. Standard appliance installs are a one-visit job when you know what you're doing — and we do them every week.",
        "included": [
            "Dishwasher installation — power, water supply, drain line, mounted to cabinets and levelled",
            "Washer/dryer hookup — braided water lines, new dryer cord (3-prong to 4-prong conversion included)",
            "Over-range microwave — bracket install, vent kit, cabinet mount",
            "Range hood installation with through-wall or through-roof venting",
            "Refrigerator water line for ice-maker and filter installs",
            "Gas dryer and gas range appliance swaps (connection only — shut-off work as needed)",
            "Old appliance disconnected and moved to the curb for pickup, or hauled away for a small fee",
            "Every connection tested and leak-checked before we leave",
        ],
        "faqs": [
            ("How much does appliance installation cost?", "Dishwasher install $160–220. Washer/dryer hookup $120–180 each. Range hood with venting $220–320 depending on run length. Over-range microwave $180–240."),
            ("Can you haul the old appliance away?", "Yes — either to your curb for municipal pickup (free) or hauled to a depot for $40–60 depending on the unit."),
            ("Do you handle gas appliances?", "Yes for connections that use a shut-off valve and certified flex line. New gas line installs require a licensed gas fitter — we'll refer."),
        ],
        "related": ["kitchen-fixtures", "plumbing-minor", "electrical-minor"],
    },
    "bathroom-fixtures": {
        "name": "Bathroom Fixtures",
        "pa": "ਬਾਥਰੂਮ ਫਿਕਸਚਰ",
        "short_verb": "swap bathroom fixtures",
        "hero_adjective": "swapped without tearing up the tile",
        "price_from": 140, "price_to": 520, "price_hint": "fixture supplied by you or at cost",
        "intro": "Toilets that rock. Vanities that are cracked or mouldy at the base. Medicine cabinets hanging off two drywall anchors. Towel bars that ripped out of the wall. Standard bathroom-fixture swaps are half-day work when done properly — anchored, sealed, and level.",
        "included": [
            "Toilet replacement — old toilet removed, flange inspected/replaced, new wax or foam ring, levelled and caulked",
            "Bathroom vanity swap — plumbing disconnected, old vanity removed, new unit levelled, water lines reconnected",
            "Medicine cabinet installation — stud-anchored, levelled, mirror protection during mount",
            "Towel bar, robe hook, toilet paper holder remounting with proper anchors for tile",
            "Exhaust fan/vent replacement (non-duct-rework)",
            "Shower head and hand-shower kit replacement, including hidden shut-off valves if needed",
            "Caulking around tub, vanity base, and toilet base — sanitary silicone",
            "Old fixtures disposed of properly; tile chips inspected; dust vacuumed",
        ],
        "faqs": [
            ("How much does it cost to install a toilet?", "Straight swap on a working flange $160–220 including wax ring and sealant. Flange repair adds $60–120. New toilet supply line, new angle stop, and caulking all included."),
            ("Can you install a new vanity?", "Yes — standard-size swaps $240–340 labour. Vanity top install with sink cutout $300–520 depending on counter material. We coordinate with the plumbing so it's one visit."),
            ("Do you replace bathroom exhaust fans?", "Yes — swap-in replacement using the existing duct run. New ducting through the attic is a bigger job, we'll quote on-site."),
        ],
        "related": ["plumbing-minor", "tile-regrout", "caulking-weatherproofing"],
    },
    "kitchen-fixtures": {
        "name": "Kitchen Fixtures",
        "pa": "ਰਸੋਈ ਫਿਕਸਚਰ",
        "short_verb": "upgrade a kitchen fixture",
        "hero_adjective": "without ripping out the counters",
        "price_from": 140, "price_to": 480, "price_hint": "fixture at cost or supplied",
        "intro": "A new faucet the wife bought six months ago still sitting in the box. A leaky garburator. A backsplash tile that cracked. A cabinet door that won't close flush because the hinge is bent. Kitchen fixture work is where small fixes save the whole room.",
        "included": [
            "Kitchen faucet swap — old faucet removed, angle stops checked/replaced, new faucet mounted and leak-tested",
            "Garburator replacement — 1/2 HP or 3/4 HP unit swap, dishwasher drain rerouted as needed",
            "Pot-filler installation behind the range (where rough plumbing exists)",
            "Soap dispenser install, under-sink water filter setup, instant-hot water tap install",
            "Cabinet hinge replacement and soft-close damper install",
            "Backsplash tile repair — cracked or fallen tile re-set, grout matched",
            "Under-cabinet lighting strip install with hidden cable routing",
            "Every connection tested; paper towel check under every sink line before we leave",
        ],
        "faqs": [
            ("How much does a kitchen faucet install cost?", "Standard pull-down faucet swap $160–220 including angle stop upgrade to 1/4-turn. Your faucet or ours — we can pick up mid-range Moen or Delta."),
            ("Do you install garburators?", "Yes — $220–320 labour including electrical connection and dishwasher drain rerouting. Unit supplied by you or by us at cost."),
            ("Can you fix cabinet doors that don't close right?", "Yes — hinge swap, soft-close damper install, or full cabinet alignment. Usually $40–80 per door."),
        ],
        "related": ["plumbing-minor", "appliance-installation", "tile-regrout"],
    },
    "flooring-repair": {
        "name": "Flooring Repair",
        "pa": "ਫਰਸ਼ ਮੁਰੰਮਤ",
        "short_verb": "fix a floor board or tile",
        "hero_adjective": "one board, not the whole room",
        "price_from": 120, "price_to": 600, "price_hint": "per-board + travel",
        "intro": "One laminate board with a chip from a dropped cast-iron pan. A vinyl plank that lifted at the edge. A squeaky spot near the kitchen. A cracked tile in the front entrance. Most flooring problems are one-board, one-tile fixes — not a full replacement.",
        "included": [
            "Single laminate plank replacement — matching from your spares or close-matched from Home Depot/Rona",
            "Vinyl plank (LVT) re-set or replacement with matching edges",
            "Cracked ceramic/porcelain tile removal and replacement with matching spare",
            "Subfloor screw-down for squeaky spots where finished floor is screw-friendly",
            "Transition strip repair between flooring types",
            "Quarter-round and shoe molding touch-up or replacement",
            "Threshold re-setting at exterior doors",
            "Disposal of old flooring waste; no dust tracked beyond the drop cloth",
        ],
        "faqs": [
            ("Can you fix just one laminate board?", "If you have a spare, yes — $120–180 including the labour to pop the row, swap the board, and re-lock. If we source the match, add the board cost."),
            ("How much does tile repair cost?", "Single cracked tile replacement $160–240 including grout. Large area (6+ tiles from one water event) $400–600. Matching the tile depends on supply."),
            ("Can you fix squeaky floors?", "Often yes — from above if the floor is screw-friendly, from below if the basement ceiling is open. Quiet fixes without floor damage."),
        ],
        "related": ["general-repairs", "tile-regrout", "caulking-weatherproofing"],
    },
    "gutter-cleaning": {
        "name": "Gutter Cleaning",
        "pa": "ਨਾਲੇ ਦੀ ਸਫ਼ਾਈ",
        "short_verb": "clean your gutters",
        "hero_adjective": "before the next storm overflows them",
        "price_from": 140, "price_to": 260, "price_hint": "full-house flat rate",
        "intro": "Gutters packed with maple keys, oak leaves, and Brampton's famous October ice-dam-in-waiting debris. Overflowing downspouts staining your brick. Water pooling at the foundation. A seasonal clean keeps your fascia, soffits, and basement dry — and costs less than one restoration call.",
        "included": [
            "Hand-scoop debris removal from all gutter runs on bungalows and 2-storey homes",
            "Downspout flushing with a garden hose to confirm clear flow",
            "Downspout strainer inspection and re-seating",
            "Visual check for sagging or pulling gutters, loose spikes, and ferrule reseating",
            "Photo documentation of any problem areas we flag (sagging, rust, gaps)",
            "Debris bagged and left at your curb, or hauled away for a small fee",
            "Tarping over garden beds so nothing stains your flower bed mulch",
            "Spring, fall, or as-needed scheduling — we remind you by text before the next season",
        ],
        "faqs": [
            ("How much does gutter cleaning cost in the GTA?", "Bungalow flat-rate $140–160. 2-storey detached $180–220. 3-storey or long-run homes $220–260. Single flat rate — no per-linear-foot math."),
            ("How often should gutters be cleaned?", "Twice a year for most GTA homes — once in late spring after the maple keys drop, once in late fall after the leaves. Homes with overhanging trees may need 3×."),
            ("Can you install gutter guards?", "Yes — we install snap-in mesh guards on existing gutters. Aluminum screens $8–12/linear foot installed. We prefer mesh over foam or bristle — less clogging."),
        ],
        "related": ["pressure-washing", "deck-fence-repair", "general-repairs"],
    },
    "pressure-washing": {
        "name": "Pressure Washing",
        "pa": "ਪ੍ਰੈਸ਼ਰ ਵਾਸ਼ਿੰਗ",
        "short_verb": "pressure-wash surfaces",
        "hero_adjective": "driveway back to new",
        "price_from": 180, "price_to": 480, "price_hint": "per-surface flat rate",
        "intro": "The driveway's gone from grey to green with algae. The back deck has a layer of winter grime before stain. The garage floor looks like a Home Depot parking lot. Standard pressure washing on the surfaces most homes have is a same-day, dry-in-an-hour job.",
        "included": [
            "Driveway pressure wash — concrete, interlock, asphalt (with the right tip for each)",
            "Back deck and patio pre-stain wash, including between-board debris removal",
            "Fence and siding wash for vinyl, aluminum, and painted wood (low-pressure on siding)",
            "Garage floor and exterior concrete pads",
            "Exterior brick wall algae and moss removal",
            "Gutter exterior wash (the streaks down the soffit)",
            "Eco-safe detergent when needed — no run-off into your grass",
            "Surfaces checked for damage after — no etched concrete, no lifted vinyl",
        ],
        "faqs": [
            ("How much does pressure washing cost?", "Standard driveway $180–240. Driveway + walkway + front porch $260–320. Add back deck $100–140. Full property package (driveway, deck, siding, fence) $380–480."),
            ("Will pressure washing damage my interlock?", "Not when done at the right PSI (2000–2800 on interlock) with the right tip. Too-close contact or a 0° tip will etch — we don't use either. Re-sanding joints available add-on."),
            ("Can you do this in spring for deck prep?", "Yes — most of our deck-staining jobs start with a power wash 24–48 hours before. Book both in one call for a combined rate."),
        ],
        "related": ["gutter-cleaning", "deck-fence-repair", "general-repairs"],
    },
    "tile-regrout": {
        "name": "Tile Regrout & Repair",
        "pa": "ਟਾਇਲ ਰੀਗ੍ਰਾਉਟ",
        "short_verb": "regrout tile",
        "hero_adjective": "grout that's clean and bright again",
        "price_from": 160, "price_to": 420, "price_hint": "per bathroom or kitchen",
        "intro": "Grout lines that have gone dark, cracked, or mildewy. One cracked tile in the shower surround. Loose tiles along the edge of the tub. Regrouting instead of re-tiling is a fraction of the cost and takes an afternoon. Done right, it looks new for another 8–10 years.",
        "included": [
            "Old grout removed with an oscillating multi-tool (not just bleached over top)",
            "Loose tiles re-set with fresh thin-set; properly back-buttered and plumb",
            "Fresh sanded or unsanded grout packed into lines — mildew-resistant formulation",
            "Grout haze buffed clean after curing",
            "Caulking at changes-of-plane (tub-to-tile, floor-to-wall) with sanitary silicone",
            "Colour matching from samples at Home Depot, Olympia Tile, or wherever your tile was sourced",
            "Single cracked-tile replacement including chiselled-out old tile and fresh set",
            "Cured 48 hours before full shower use — we tell you the schedule on the way out",
        ],
        "faqs": [
            ("How much does regrouting a shower cost?", "Standard tub surround regrout $240–340. Walk-in shower $340–420. Kitchen backsplash $180–280. Loose or cracked tile add-on $40–60 per tile."),
            ("Is regrouting a good idea vs full replacement?", "Almost always yes — if the tiles themselves are sound and only the grout is damaged, regrouting saves 80–90% vs a full re-tile and lasts 8–10 years."),
            ("Will the new grout match my old tile?", "We bring colour samples. Most cement-based grout is available in 30+ shades; stone tile sometimes needs unsanded. Colour match is usually within one shade of original."),
        ],
        "related": ["bathroom-fixtures", "caulking-weatherproofing", "flooring-repair"],
    },
    "smoke-alarm-install": {
        "name": "Smoke Alarm & CO Install",
        "pa": "ਸਮੋਕ ਅਤੇ ਕਾਰਬਨ ਮੋਨੋਕਸਾਈਡ ਅਲਾਰਮ",
        "short_verb": "install smoke and CO alarms",
        "hero_adjective": "Ontario Fire Code compliant",
        "price_from": 85, "price_to": 220, "price_hint": "alarm supplied or at cost",
        "intro": "Ontario law requires a smoke alarm on every floor including finished basements and outside every sleeping area. CO alarm near any fuel-burning appliance and attached garage. Most homes are under-equipped without realizing it. A quick audit plus the right alarms takes under an hour and keeps your family and insurance in compliance.",
        "included": [
            "Smoke alarm installation on every floor and outside every sleeping area (Ontario Fire Code)",
            "CO alarm placement within 5m of sleeping areas on floors with fuel appliances",
            "Hardwired alarm replacement where existing boxes exist — no new wiring needed",
            "Battery-powered interconnected alarm network setup (wireless models like First Alert/Kidde)",
            "10-year sealed lithium battery alarm installation — no yearly swaps",
            "Old-alarm dust-out and testing; clear-out of 10+ year old units (past useful life)",
            "Mounting bracket secured into ceiling studs; no drywall-only install",
            "Test button pressed and confirmed on every alarm before we leave",
        ],
        "faqs": [
            ("How many smoke alarms do I need in Ontario?", "One on every floor (including finished basement), plus one outside each sleeping area. A 2-storey home with a basement typically needs 4–5 smoke alarms plus 1–2 CO alarms."),
            ("Can you install hardwired alarms?", "Yes, as direct replacements on existing boxes. New-circuit hardwiring requires a licensed electrician — we'll refer. Most homeowners are fine with 10-year sealed battery models anyway."),
            ("Are you licensed for this?", "Installing smoke and CO alarms doesn't require a license — it's a homeowner-permitted task. We follow TSSA and Fire Code placement rules carefully."),
        ],
        "related": ["electrical-minor", "general-repairs", "door-window-repair"],
    },
}
...
AREAS = {
    ...
    "downtown-brampton": {
        "display": "Downtown Brampton",
        "pa": "ਡਾਊਨਟਾਊਨ ਬਰੈਂਪਟਨ",
        "type": "neighbourhood",
        "parent": "Brampton",
        "postal_codes": ["L6Y", "L6X"],
        "housing": "a mix of pre-war century homes, 1950s–60s bungalows around Queen Street East, and newer mid-rise condos along the GO corridor",
        "landmarks": "Rose Theatre, Gage Park, Brampton City Hall, Downtown GO Station",
        "drive_notes": "central Brampton — we base most of our weekday routing through here, so same-day slots are easy",
        "hook": "the century homes east of Queen and the newer mid-rise condos north of the GO tracks",
    },
    "northwood-brampton": {
        "display": "Northwood",
        "pa": "ਨੌਰਥਵੁੱਡ",
        ...
        "parent": "Brampton",
        "postal_codes": ["L6Z"],
        "housing": "established 1980s single-family detached and linked-townhouse blocks with mature trees and maturing roofs",
        "landmarks": "Northwood Park, Heart Lake Road at Mayfield, North Park Drive corridor",
        "drive_notes": "12 minutes from central Brampton — we're in Northwood several times a month for deck staining and older-home drywall work",
        "hook": "the 80s-built detached and linked homes between Heart Lake Road and Kennedy",
    },
    "snelgrove": {
        "display": "Snelgrove",
        "pa": "ਸਨੈਲਗ੍ਰੋਵ",
        ...
        "parent": "Brampton",
        "postal_codes": ["L7A"],
        "housing": "newer 2000s detached and semi-detached homes along the Kennedy Road North corridor, plus some pre-2000 country lots at the Caledon border",
        "landmarks": "Snelgrove Community Centre, Kennedy Road North, Mayfield Road",
        "drive_notes": "20 minutes from downtown Brampton — we head up to Snelgrove weekly, often paired with Caledon jobs",
        "hook": "the newer Kennedy Road North detached blocks and the Mayfield border-zone homes",
    },
    "huttonville": {
        "display": "Huttonville",
        "pa": "ਹਟਨਵਿਲ",
        ...
        "parent": "Brampton",
        "postal_codes": ["L6X"],
        "housing": "a historic rural village with a handful of century properties, plus larger detached homes on big lots off Mississauga Road",
        "landmarks": "Huttonville Public School, Creditview Road, the old village core by Mississauga Road",
        "drive_notes": "20 minutes from east Brampton — we cover Huttonville along with Meadowvale and Mount Pleasant runs",
        "hook": "the bigger lots along Mississauga Road and the original village properties around Embleton",
    },
    "churchville": {
        "display": "Churchville",
        "pa": "ਚਰਚਵਿਲ",
        ...
        "parent": "Brampton",
        "postal_codes": ["L6Y"],
        "housing": "a small heritage village pocket with century homes, mature lots, and a protected streetscape — careful hands required for older trim and plaster",
        "landmarks": "Churchville Heritage Park, Creditview at Embleton, the historic village core",
        "drive_notes": "18 minutes from central Brampton — we approach Churchville with the patience these older homes deserve",
        "hook": "the protected-heritage century homes around Creditview and Embleton",
    },
    "sandalwood": {
        "display": "Sandalwood",
        "pa": "ਸੈਂਡਲਵੁੱਡ",
        "type": "neighbourhood",
        "parent": "Brampton",
        "postal_codes": ["L6R", "L7A"],
        "housing": "early-2000s detached homes along Sandalwood Parkway and Countryside Drive, plus freehold townhouse blocks in newer pockets",
        "landmarks": "Sandalwood Parkway, Countryside Drive, Terra Cotta Park",
        "drive_notes": "10–15 minutes from central Brampton — Sandalwood is on our regular route, especially for newer-home TV mounts and assembly jobs",
        "hook": "the 2000s detached and linked homes along Sandalwood and Countryside",
    },
    "malton": {
        "display": "Malton",
        "pa": "ਮਾਲਟਨ",
        "type": "neighbourhood",
        "parent": "Mississauga",
        "postal_codes": ["L4T", "L5A"],
        "housing": "1970s–80s detached bungalows and townhouse complexes near Pearson Airport, plus pockets of newer infill and industrial-edge homes",
        "landmarks": "Westwood Mall, Derry Road East, Morning Star Drive, Pearson Airport north",
        "drive_notes": "15 minutes from south Brampton — we service Malton almost daily, especially for the Punjabi families we've worked with for years",
        "hook": "the Westwood Mall-area bungalows and the newer infill homes around Morning Star",
    },
    "streetsville": {
        "display": "Streetsville",
        "pa": "ਸਟ੍ਰੀਟਸਵਿਲ",
        "type": "neighbourhood",
        "parent": "Mississauga",
        "postal_codes": ["L5M"],
        "housing": "a historic main-street village with century homes on old Mississauga Road, newer townhouses east of the core, and modern detached builds toward Erin Mills",
        "landmarks": "Streetsville BIA, Queen Street South, Mississauga Road historic district",
        "drive_notes": "25 minutes from central Brampton — Streetsville is one of our standing Tuesday runs",
        "hook": "the historic homes on Queen Street South and the newer townhouses east of the village",
    },
    "meadowvale": {
        "display": "Meadowvale",
        "pa": "ਮੈਡੋਵੇਲ",
        "type": "neighbourhood",
        "parent": "Mississauga",
        "postal_codes": ["L5N", "L5W"],
        "housing": "1970s–90s master-planned subdivisions, lots of mature trees, established landscaping, and original decks that are now due for repair or stain",
        "landmarks": "Meadowvale Town Centre, Lake Wabukayne, Derry Road West, Winston Churchill Boulevard",
        "drive_notes": "25 minutes from central Brampton — we pair Meadowvale jobs with Streetsville and Mount Pleasant runs",
        "hook": "the 70s–90s detached homes around Lake Wabukayne and the original Meadowvale core",
    },
    "woodbridge": {
        "display": "Woodbridge",
        "pa": "ਵੁੱਡਬ੍ਰਿਜ",
        "type": "neighbourhood",
        "parent": "Vaughan",
        "postal_codes": ["L4H", "L4L"],
        "housing": "late-90s through early-2000s detached homes with finished basements and large rear decks, plus pockets of newer infill townhouse blocks",
        "landmarks": "Woodbridge Commercial Core, Highway 7 corridor, Pine Valley Drive, Vaughan Mills",
        "drive_notes": "30 minutes from Brampton via 407 — we cover Woodbridge weekly, often pairing with Kleinburg jobs",
        "hook": "the 2000s detached blocks around Pine Valley and the historic Woodbridge village core",
    },
    "kleinburg": {
        "display": "Kleinburg",
        "pa": "ਕਲਾਈਨਬਰਗ",
        "type": "neighbourhood",
        "parent": "Vaughan",
        "postal_codes": ["L0J", "L4H"],
        "housing": "a historic village with larger estate homes, luxury detached builds, and executive properties around the McMichael gallery",
        "landmarks": "McMichael Canadian Art Collection, Nashville Road, Kleinburg village core, Copper Creek Golf Club",
        "drive_notes": "30–35 minutes from Brampton — Kleinburg estate work is part of our regular rotation, usually Wednesdays",
        "hook": "the estate homes near the McMichael and the village-core heritage properties",
    },
    "rexdale": {
        "display": "Rexdale",
        "pa": "ਰੈਕਸਡੇਲ",
        "type": "neighbourhood",
        "parent": "Toronto",
        "postal_codes": ["M9V", "M9W"],
        "housing": "1960s bungalows, post-war detached homes, and townhouse complexes around Highway 27, Rexdale Boulevard, and Albion Road",
        "landmarks": "Woodbine Mall, Rexdale Boulevard, Albion Road, Humberwood Park",
        "drive_notes": "20–25 minutes from south Brampton via Highway 27 — Rexdale is one of our fastest east-end runs",
        "hook": "the 60s bungalows off Rexdale Boulevard and the townhouse complexes around Woodbine",
    },
}
...
<head>
  <script
    src="https://js.sentry-cdn.com/533423f0ea5b36f226961dd63da7f171.min.js"
    crossorigin="anonymous"
  ></script>
  <script>
    Sentry.onLoad(function() {{
      Sentry.init({{
        dsn: "https://533423f0ea5b36f226961dd63da7f171@o4511169183678464.ingest.us.sentry.io/4511344382443520",
